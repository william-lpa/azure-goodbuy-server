...
mobile.configuration.data.server='good-buy.database.windows.net';
mobile.configuration.data.user='william-lpa';
mobile.configuration.data.password='Novaerade2011';
mobile.configuration.data.database='GoodBuy';
